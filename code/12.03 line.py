...
class LineDetector:
    ...
    def conv_image(self, data):
        ...
        img_result1 = cv2.adaptiveThreshold(dst, 255, cv2.ADAPTIVE_THRESH_GAUSSIAN_C, cv2.THRESH_BINARY, 21, 13)
        ...
        self.bird = cv2.warpPerspective(final, matrix, (485, 358))
    ...
    def detect_lines(self):
        ...
        #print(np.average(self.angle_list))
            return np.average(self.angle_list) - 88
