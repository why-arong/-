...
while True:
    ...
    #         angle = 0
    #         speed = 30
    #     print("angle",angle +90, "speed",speed + 90)
    #
    # elif (left == -1 and right != -1):
    #     diff = right - 320
    #     angle = 90 - (100 // diff)
    #     speed = 25
    #     print("angle",angle,"speed", speed + 90)
    # elif (left != -1 and right == -1):
    #     diff = left - 320
    #     angle = 90 - (100 // diff)
    #     speed = 25
    ...
    b = 320-left
    if a-b>1:#왼쪽
        print("angle",90-((a-b)//10),"speed",112)
    elif b-a>10:
        print("angle",90+((b-a)//10),"speed",112)
    else:
        print("angle", 90, "speed", 112)
cap.release()
